...
import { a4 as getAugmentedNamespace, a5 as getDefaultExportFromCjs } from './astro/server_BLfuIyYt.mjs';
...
const resolveFetch$3 = (customFetch) => {
    ...
    if (customFetch) {
        ...
        _fetch = (...args) => Promise.resolve().then(() => browser).then(({ default: fetch }) => fetch(...args));
    }
    else {
        _fetch = fetch;
    }
...
class RealtimeClient {
    ...
    connect() {
        ...
        import('./browser_DtrbRn6_.mjs').then(n => n.b).then(({ default: WS }) => {
