...
const $$03Incantations = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$03Incantations;
...
}, "/home/user/aether_scrolls/src/pages/01_singles/03_incantations.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/01_singles/03_incantations.astro";
const $$url = "/01_singles/03_incantations";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$03Incantations,
  file: $$file,
  url: $$url
