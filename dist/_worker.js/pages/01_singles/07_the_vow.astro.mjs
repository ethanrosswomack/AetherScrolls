...
async function GET({ request }) {
  const apiUrl = new URL("/api/arsenal?title=The Vow", request.url).toString();
  try {
...
const $$07TheVow = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$07TheVow;
...
}, "/home/user/aether_scrolls/src/pages/01_singles/07_the_vow.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/01_singles/07_the_vow.astro";
const $$url = "/01_singles/07_the_vow";
