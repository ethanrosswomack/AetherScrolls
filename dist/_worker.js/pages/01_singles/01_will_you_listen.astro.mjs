...
const $$01WillYouListen = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$01WillYouListen;
...
}, "/home/user/aether_scrolls/src/pages/01_singles/01_will_you_listen.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/01_singles/01_will_you_listen.astro";
const $$url = "/01_singles/01_will_you_listen";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$01WillYouListen,
  file: $$file,
  url: $$url
