...
async function GET({ request }) {
  const apiUrl = new URL("/api/arsenal?title=Politicians", request.url).toString();
  try {
...
const $$06Politicians = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$06Politicians;
...
}, "/home/user/aether_scrolls/src/pages/01_singles/06_politicians.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/01_singles/06_politicians.astro";
const $$url = "/01_singles/06_politicians";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$06Politicians,
  file: $$file,
  url: $$url
