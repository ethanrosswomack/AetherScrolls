...
const $$02Psyops = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$02Psyops;
...
}, "/home/user/aether_scrolls/src/pages/01_singles/02_psyops.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/01_singles/02_psyops.astro";
const $$url = "/01_singles/02_psyops";
