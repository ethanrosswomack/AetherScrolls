...
const $$04MindKontrol = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$04MindKontrol;
...
}, "/home/user/aether_scrolls/src/pages/01_singles/04_mind_kontrol.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/01_singles/04_mind_kontrol.astro";
const $$url = "/01_singles/04_mind_kontrol";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$04MindKontrol,
  file: $$file,
  url: $$url
