...
const $$03Kamikaze = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$03Kamikaze;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/03_kamikaze.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/03_kamikaze.astro";
const $$url = "/02_mixtape_sessions/02_behold_a_pale_horse/03_kamikaze";
