...
const $$11TheStoryCelebratedThroughoutTime = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$11TheStoryCelebratedThroughoutTime;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/11_the_story_celebrated_throughout_time.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/11_the_story_celebrated_throughout_time.astro";
const $$url = "/02_mixtape_sessions/02_behold_a_pale_horse/11_the_story_celebrated_throughout_time";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$11TheStoryCelebratedThroughoutTime,
  file: $$file,
  url: $$url
