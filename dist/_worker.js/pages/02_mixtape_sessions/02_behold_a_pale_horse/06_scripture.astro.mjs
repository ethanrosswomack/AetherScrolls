...
async function GET({ request }) {
  const apiUrl = new URL("/api/arsenal?title=Scripture", request.url).toString();
  try {
...
const $$06Scripture = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$06Scripture;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/06_scripture.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/06_scripture.astro";
const $$url = "/02_mixtape_sessions/02_behold_a_pale_horse/06_scripture";
