...
async function GET({ request }) {
  const apiUrl = new URL("/api/arsenal?title=Whistle Blower", request.url).toString();
  try {
...
const $$04Whistleblower = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$04Whistleblower;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/04_whistleblower.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/04_whistleblower.astro";
const $$url = "/02_mixtape_sessions/02_behold_a_pale_horse/04_whistleblower";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$04Whistleblower,
  file: $$file,
  url: $$url
