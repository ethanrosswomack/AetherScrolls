...
async function GET({ request }) {
  const apiUrl = new URL("/api/arsenal?title=Superstitions", request.url).toString();
  try {
...
const $$05Superstitions = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$05Superstitions;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/05_superstitions.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/05_superstitions.astro";
const $$url = "/02_mixtape_sessions/02_behold_a_pale_horse/05_superstitions";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$05Superstitions,
  file: $$file,
  url: $$url
