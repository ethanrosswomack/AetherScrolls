...
async function GET({ request }) {
  const apiUrl = new URL("/api/arsenal?title=Warning Shots", request.url).toString();
  try {
...
const $$01WarningShots = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$01WarningShots;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/01_warning_shots.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/01_warning_shots.astro";
const $$url = "/02_mixtape_sessions/02_behold_a_pale_horse/01_warning_shots";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$01WarningShots,
  file: $$file,
  url: $$url
