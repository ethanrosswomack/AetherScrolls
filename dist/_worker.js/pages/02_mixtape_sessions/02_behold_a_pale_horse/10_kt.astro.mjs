...
async function GET({ request }) {
  const apiUrl = new URL("/api/arsenal?title=K.T.", request.url).toString();
  try {
...
const $$10Kt = createComponent(async ($$result, $$props, $$slots) => {
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/10_kt.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/10_kt.astro";
const $$url = "/02_mixtape_sessions/02_behold_a_pale_horse/10_kt";
