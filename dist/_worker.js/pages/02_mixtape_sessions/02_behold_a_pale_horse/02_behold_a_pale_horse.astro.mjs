...
const $$02BeholdAPaleHorse = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$02BeholdAPaleHorse;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/02_behold_a_pale_horse.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/02_behold_a_pale_horse.astro";
const $$url = "/02_mixtape_sessions/02_behold_a_pale_horse/02_behold_a_pale_horse";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$02BeholdAPaleHorse,
  file: $$file,
  url: $$url
