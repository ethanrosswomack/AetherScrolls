...
async function GET({ request }) {
  const apiUrl = new URL("/api/arsenal?title=Reverse This Curse", request.url).toString();
  try {
...
const $$09ReverseThisCurse = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$09ReverseThisCurse;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/09_reverse_this_curse.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/09_reverse_this_curse.astro";
const $$url = "/02_mixtape_sessions/02_behold_a_pale_horse/09_reverse_this_curse";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$09ReverseThisCurse,
  file: $$file,
  url: $$url
