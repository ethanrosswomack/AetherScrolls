...
async function GET({ request }) {
  const apiUrl = new URL("/api/arsenal?title=Semi-Automatic", request.url).toString();
  try {
...
const $$08SemiAutomatic = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$08SemiAutomatic;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/08_semi_automatic.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/02_behold_a_pale_horse/08_semi_automatic.astro";
const $$url = "/02_mixtape_sessions/02_behold_a_pale_horse/08_semi_automatic";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$08SemiAutomatic,
  file: $$file,
  url: $$url
