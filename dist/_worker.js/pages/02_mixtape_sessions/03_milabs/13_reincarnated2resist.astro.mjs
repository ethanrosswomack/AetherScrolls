...
const $$13Reincarnated2Resist = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$13Reincarnated2Resist;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/13_reincarnated2resist.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/13_reincarnated2resist.astro";
const $$url = "/02_mixtape_sessions/03_milabs/13_reincarnated2resist";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$13Reincarnated2Resist,
  file: $$file,
  url: $$url
