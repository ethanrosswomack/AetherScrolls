...
const $$09Avalanche = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$09Avalanche;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/09_avalanche.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/09_avalanche.astro";
const $$url = "/02_mixtape_sessions/03_milabs/09_avalanche";
