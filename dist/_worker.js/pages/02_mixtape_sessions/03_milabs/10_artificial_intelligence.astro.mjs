...
async function GET({ request }) {
  ...
  const title = fileName.replace(/^\d+_/, "").replace(/_/g, " ").replace(/\b\w/g, (l) => l.toUpperCase());
  const album = "Milabs";
...
const $$10ArtificialIntelligence = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$10ArtificialIntelligence;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/10_artificial_intelligence.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/10_artificial_intelligence.astro";
const $$url = "/02_mixtape_sessions/03_milabs/10_artificial_intelligence";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$10ArtificialIntelligence,
  file: $$file,
  url: $$url
