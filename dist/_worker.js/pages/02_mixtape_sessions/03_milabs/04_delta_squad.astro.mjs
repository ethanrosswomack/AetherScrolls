...
const $$04DeltaSquad = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$04DeltaSquad;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/04_delta_squad.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/04_delta_squad.astro";
const $$url = "/02_mixtape_sessions/03_milabs/04_delta_squad";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$04DeltaSquad,
  file: $$file,
  url: $$url
