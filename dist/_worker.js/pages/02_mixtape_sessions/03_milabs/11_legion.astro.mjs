...
const $$11Legion = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$11Legion;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/11_legion.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/11_legion.astro";
const $$url = "/02_mixtape_sessions/03_milabs/11_legion";
