...
const $$05Implants = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$05Implants;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/05_implants.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/05_implants.astro";
const $$url = "/02_mixtape_sessions/03_milabs/05_implants";
