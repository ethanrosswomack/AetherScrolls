...
const $$01SoftDisclosure = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$01SoftDisclosure;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/01_soft_disclosure.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/01_soft_disclosure.astro";
const $$url = "/02_mixtape_sessions/03_milabs/01_soft_disclosure";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$01SoftDisclosure,
  file: $$file,
  url: $$url
