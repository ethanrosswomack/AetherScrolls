...
const $$03EyesWideOpen = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$03EyesWideOpen;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/03_eyes_wide_open.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/03_eyes_wide_open.astro";
const $$url = "/02_mixtape_sessions/03_milabs/03_eyes_wide_open";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$03EyesWideOpen,
  file: $$file,
  url: $$url
