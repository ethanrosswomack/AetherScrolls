...
const $$02Abreactions = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$02Abreactions;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/02_abreactions.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/02_abreactions.astro";
const $$url = "/02_mixtape_sessions/03_milabs/02_abreactions";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$02Abreactions,
  file: $$file,
  url: $$url
