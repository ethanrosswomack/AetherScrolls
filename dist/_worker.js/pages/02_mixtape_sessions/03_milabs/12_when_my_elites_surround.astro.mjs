...
const $$12WhenMyElitesSurround = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$12WhenMyElitesSurround;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/12_when_my_elites_surround.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/12_when_my_elites_surround.astro";
const $$url = "/02_mixtape_sessions/03_milabs/12_when_my_elites_surround";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$12WhenMyElitesSurround,
  file: $$file,
  url: $$url
