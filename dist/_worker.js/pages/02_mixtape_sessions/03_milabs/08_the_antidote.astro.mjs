...
const $$08TheAntidote = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$08TheAntidote;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/08_the_antidote.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/08_the_antidote.astro";
const $$url = "/02_mixtape_sessions/03_milabs/08_the_antidote";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$08TheAntidote,
  file: $$file,
  url: $$url
