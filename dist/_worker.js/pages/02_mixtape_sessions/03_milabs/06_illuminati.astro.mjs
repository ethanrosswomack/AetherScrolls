...
const $$06Illuminati = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$06Illuminati;
...
}, "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/06_illuminati.astro", void 0);

const $$file = "/home/user/aether_scrolls/src/pages/02_mixtape_sessions/03_milabs/06_illuminati.astro";
const $$url = "/02_mixtape_sessions/03_milabs/06_illuminati";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  GET,
  default: $$06Illuminati,
  file: $$file,
  url: $$url
